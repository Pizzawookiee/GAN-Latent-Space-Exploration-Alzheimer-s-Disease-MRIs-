# -*- coding: utf-8 -*-
"""
Created on Fri Nov 18 11:54:38 2022

@author: dtlee
"""

#source: https://code.adonline.id.au/structural-similarity-index-ssim-in-python/
...
def return_ssim (original, altered):
    image1 = cv2.imread(original)
    image2 = cv2.imread(altered)
